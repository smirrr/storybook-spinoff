...
// TODO: Understand what the issue here is
...
const transformAlias = (prop, propValue) => {
  ...
  if (configKeys.includes(prop)) {
    ...
    if (properties) {
      // TODO: refactor this to not return an assignment, or to not use an arrow function
...
export const transformAliasProps = (props) => {
  let result = {};
  // TODO: refactor this to not iterate over the entire prototype chain (use Object.keys/values and iterate over that instead)
